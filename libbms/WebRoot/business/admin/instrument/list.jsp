		...
		<div id="pagebody">
		  <div id="mainbody">
		      <div id="contentbar">
					<h1>检验仪器列表</h1>
					<div class="main-blk">
							<s:form action="/business/admin/instrument/listInstrument.html"  namespace="/business/admin">
							<table border="0" cellpadding="0" cellspacing="0" class="lsttable">
							    <tr>
                                   <td>编码名称：</td><td><s:textfield name="instrument.codename"></s:textfield></td>
                                   <td>生产单位：</td><td><s:textfield name="instrument.product"></s:textfield></td>
							...
							<div id="opbar">
									<input type="image" name="imageField2" id="imageField2" onclick="window.location.href='<s:url action="addInstrument"/>'" src="<%=path %>/img/add.png"/>
							</div>
					</div>
