...
<html>
	...
	<div id="contentbar">
		<h1>修改检验仪器</h1>
		<s:form action="updateInstrument" namespace="/business/admin">
		<table class="frmtable">
		<s:hidden id="instrumentid" name="instrument.id"></s:hidden>
		...
		<tr><td>最近校准日期：</td><td><s:textfield id="recentdate" name="instrument.recentCorrectDate"  readonly="readonly" cssClass="shorttext"><s:param name="value"><s:date name="instrument.recentCorrectDate" format="yyyy-MM-dd"/></s:param></s:textfield></td></tr>
		<tr><td>下次校准日期：</td><td><s:textfield id="nextdate" name="instrument.nextCorrectDate"  readonly="readonly" cssClass="shorttext"><s:param name="value"><s:date name="instrument.nextCorrectDate" format="yyyy-MM-dd"/></s:param></s:textfield></td></tr>
	    ...
	    function checkCode(){
	       $.ajax({
				...
				data:{iid:$("#instrumentid").val(), codename:$("#codename").val()},
				dataType:'json',
