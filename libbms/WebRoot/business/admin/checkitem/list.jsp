		...
		<div id="pagebody">
		  <div id="mainbody">
		      <div id="contentbar">
					<h1>检验项目列表</h1>
					<div class="main-blk">
							<s:form action="/business/admin/checkitem/listCheckItem.html"  namespace="/business/admin">
							<table border="0" cellpadding="0" cellspacing="0" class="lsttable">
							<tr>
                                   <td>检验项目名称：</td><td><s:textfield name="checkItem.checkitem"></s:textfield></td>
							...
							<div id="opbar">
									<input type="image" name="imageField2" id="imageField2" onclick="window.location.href='<s:url action="addCheckItem"/>'" src="<%=path %>/img/add.png"/>
							</div>
					</div>
