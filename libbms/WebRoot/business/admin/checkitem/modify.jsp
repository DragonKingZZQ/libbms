...
<html>
	...
	<div id="contentbar">
		<h1>修改检验项目</h1>
		<s:form action="updateCheckItem" namespace="/business/admin">
		<table class="frmtable">
		<s:hidden id="checkid" name="checkItem.id"></s:hidden>
	    ...
	    function checkCode(){
	       $.ajax({
	            async:false,
	            type:'get',
				url: 'isExistsCheckItem.html',
				data:{cid:$("#checkid").val(),checkname:$("#checkname").val()},
				dataType:'json',
