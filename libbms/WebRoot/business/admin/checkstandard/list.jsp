		...
		<div id="pagebody">
		  <div id="mainbody">
		      <div id="contentbar">
					<h1>检验标准列表</h1>
					<div class="main-blk">
							<s:form action="/business/admin/checkstandard/listCheckStandard.html"  namespace="/business/admin">
							<table border="0" cellpadding="0" cellspacing="0" class="lsttable">
							<tr>
                                   <td>检验标准编码：</td><td><s:textfield name="checkStandard.standardcode"></s:textfield></td>
							...
							<div id="opbar">
									<input type="image" name="imageField2" id="imageField2" onclick="window.location.href='<s:url action="addCheckStandard"/>'" src="<%=path %>/img/add.png"/>
							</div>
					</div>
