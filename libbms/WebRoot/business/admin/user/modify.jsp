...
<html>
	...
	<div id="contentbar">
		<h1>修改员工</h1>
		<s:form action="updateUser" namespace="/business/admin">
		<table class="frmtable">
		<s:hidden id="userid" name="user.uid"></s:hidden>
		<s:hidden name="user.groupid"></s:hidden>
		...
		<tr><td><span class="mustfill">*</span>用户密码：</td><td><s:password  name="user.password" data-validation="length" data-validation-length="0-8" data-validation-error-msg="字数范围在(0-8)" cssClass="longtext"></s:password></td></tr>
	    ...
	    function checkName(){
	       $.ajax({
				...
				data:{uid:$("#userid").val(), name:$("#name").val()},
				dataType:'json',
